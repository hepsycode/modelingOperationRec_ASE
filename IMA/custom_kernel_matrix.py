...
class CustomKernelMatrix(Kernel):
    ...
    def __init__(self,
        ...
        #self._valid_parameters |= vocabulary

        super(CustomKernelMatrix, self).__init__(n_jobs=n_jobs, verbose=verbose, normalize=normalize)
        ...
        #self.initialized_.update({ vocabulary : None  })
    ...
    def initialize_(self):
        ...
        super(CustomKernelMatrix, self).initialize()
