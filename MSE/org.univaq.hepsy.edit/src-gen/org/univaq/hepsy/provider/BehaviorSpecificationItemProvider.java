...
/**
 * This is the item provider adapter for a {@link org.univaq.hepsy.BehaviorSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorSpecificationItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HepsyPackage.Literals.BEHAVIOR_SPECIFICATION__NODES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case HepsyPackage.BEHAVIOR_SPECIFICATION__NODES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(HepsyPackage.Literals.BEHAVIOR_SPECIFICATION__NODES,
				HepsyFactory.eINSTANCE.createStructuredNode()));

		newChildDescriptors.add(createChildParameter(HepsyPackage.Literals.BEHAVIOR_SPECIFICATION__NODES,
				HepsyFactory.eINSTANCE.createProcess()));

		newChildDescriptors.add(createChildParameter(HepsyPackage.Literals.BEHAVIOR_SPECIFICATION__NODES,
				HepsyFactory.eINSTANCE.createDisplay()));

		newChildDescriptors.add(createChildParameter(HepsyPackage.Literals.BEHAVIOR_SPECIFICATION__NODES,
				HepsyFactory.eINSTANCE.createStimulus()));
	}
